...
#include <rclcpp/rclcpp.hpp>//导入ros2的C++客户端库
#include <rclcpp_action/rclcpp_action.hpp>//导入ros2的C++Action客户端库
...
public:
    ...
    void sendGoal()
    {
        ...
        action_client_->async_send_goal(goal_msg, send_goal_options); // 发送导航目标点
    }
